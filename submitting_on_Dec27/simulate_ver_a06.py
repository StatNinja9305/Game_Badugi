...
class MyCards():
    ...
    def save_badugi_hand_name_table(self, num = int(1E4)):
        reports = self._get_total_hand_classification_reports(num)
...
deck = MyCards()
deck.save_badugi_hand_name_table(num = None)
#deck._debug_case_4()
